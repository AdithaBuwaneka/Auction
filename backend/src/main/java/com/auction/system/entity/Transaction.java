...
@Table(name = "transactions", indexes = {
        @Index(name = "idx_trans_buyer_id", columnList = "buyer_id"),
        @Index(name = "idx_trans_seller_id", columnList = "seller_id"),
        @Index(name = "idx_trans_auction_id", columnList = "auction_id")
})
@Data
@NoArgsConstructor
@AllArgsConstructor
